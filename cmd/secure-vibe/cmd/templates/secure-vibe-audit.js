...
// The binary is deterministic and passive: it never calls an LLM and never
// sends attack traffic. The reasoning here is the agent's — the per-directory
// agents may read code and reason about each finding, and any dynamic
// verification is the agent's job via the scope-gated http_probe / oob_listener
// MCP primitives (see the dynamic-verification skill), never this script.
